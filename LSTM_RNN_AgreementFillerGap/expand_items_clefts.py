...
conditions = {
    ...
    'npl_l4_vpl': ['prefix', 'npl', 'who','level4', 'vpl','continuation'],
    'npl_l4_vsg': ['prefix', 'npl', 'who','level4', 'vsg','continuation'],
    'nsg_l4_vpl': ['prefix', 'nsg', 'who','level4', 'vpl','continuation'],
    'nsg_l4_vsg': ['prefix', 'nsg', 'who','level4', 'vsg','continuation']
